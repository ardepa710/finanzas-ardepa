/**
 * GET /api/reportes/gastos - Expense report with trends
 */

import { withErrorHandling, APIError, ErrorCodes } from '@/lib/api-error'
import { generateGastosReport } from '@/features/reportes/services/report-generator'
...
export const GET = withErrorHandling(async (req: Request) => {
  ...
  const report = await generateGastosReport({
    inicio: inicioDate,
    fin: finDate,
  })
